    ...
    if (sendButton) {
        ...
        sendButton.onclick = async (e) => {
            ...
            if (originalClickHandler) {
                await originalClickHandler.call(sendButton, e);
            }
        ...
        if (token && loginButton) {
            ...
            userProfileDiv.innerHTML = `
                ...
                <div class="user-dropdown">
                    <div class="dropdown-item view-profile">查看个人信息</div>
                    <div class="dropdown-item logout">退出登录</div>
                </div>
            `;
            
            loginButton.parentElement.replaceChild(userProfileDiv, loginButton);
