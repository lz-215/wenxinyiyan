document.addEventListener('DOMContentLoaded', () => {
    ...
    if ((!stateLoaded && queryParam) || (isNewCardNavigation && !isSameQuery)) {
        ...
        document.title = `${shortTitle} - Wenxin Yiyan Free AI Assistant`;
        
        // 添加AI响应加载中的消息
        const aiAvatarSrc = 'assets/images/favicon.png';
        ...
        if (!queryParam) {
            const aiAvatarSrc = 'assets/images/favicon.png';
            const welcomeMessage = '<p>Welcome to Wenxin Yiyan AI Assistant, please type your question below.</p>';
    ...
    function clearChat() {
        ...
        // 重置页面标题
        document.title = 'Wenxin Yiyan Free AI Assistant (No Login Required)';
    ...
    function stopApiRequest() {
        if (currentApiController) {
            ...
            // 我们不需要显式更新HTML，因为handleApiResponse的catch块会处理
            updateSendButtonState(false);
        }
    }
